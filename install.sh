...
if [ "$SCRIPT_PATH" != "/usr/bin/menu" ]; then
    ...
    echo "=========================================================="
    echo "  [INFO] Shortcut berhasil dibuat/diperbarui!"
...
while true; do
    ...
    echo "6. Update Bot (Tarik Kode Terbaru & Hapus Cache)"
...
EOF
                ...
                echo "[2/3] Memperbarui library Node.js (Menghapus cache dan force install versi GitHub)..."
