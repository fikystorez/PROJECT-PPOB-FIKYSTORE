#!/bin/bash
# ==========================================================
# DIGITAL FIKY STORE - V139 (THE ABSOLUTE COMPLETE EDITION)
# ==========================================================
...
echo "=========================================================="
echo "    MENGINSTAL DIGITAL FIKY STORE V139 (FULL SCRIPT)      "
echo "=========================================================="
...
# 2. STYLE CSS 
# ==========================================
echo "[3/5] Membangun Antarmuka CSS & HTML (FULL UNCOMPRESSED)..."
    ...
    document.getElementById('resetForm').addEventListener('submit', async (e) => {
      ...
      try {
        const res = await fetch('/api/auth/reset', { 
          method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ phone: resetPhone, otp, newPassword }) 
        });
...
# =========================================================
# FILE-FILE YANG SEMPAT TERLEWAT SEKARANG DIKEMBALIKAN UTUH
# =========================================================

# 1. PROFILE.HTML (PENTING!)
...
while true; do clear
    echo -e "${CYAN}======================================================${NC}"
    echo -e "${YELLOW}          💎 PANEL DIGITAL FIKY STORE (V139) 💎       ${NC}"
    echo -e "${CYAN}======================================================${NC}"
    echo ""
...
pm2 restart all > /dev/null 2>&1
echo "=========================================================="
echo "  SISTEM WEB V139 BERHASIL DIPERBARUI SECARA PENUH!       "
