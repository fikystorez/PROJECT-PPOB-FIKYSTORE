...
<body class="bg-gray-50 dark:bg-[#0b1320] font-sans transition-colors duration-300">
    <div class="max-w-md mx-auto bg-gray-50 dark:bg-[#0b1320] min-h-screen relative pb-24 shadow-2xl overflow-x-hidden transition-colors duration-300">
        ...
        <div class="mx-4 mt-2 bg-[#002147] rounded-[1.5rem] p-6 text-white relative overflow-hidden shadow-lg border border-[#1e3a8a]">
            ...
            <div class="text-center relative z-10">
                ...
                <div class="flex gap-4">
                    <button class="flex-1 border border-gray-500/50 bg-[#001229]/50 text-white rounded-full py-2.5 text-[11px] font-bold hover:bg-yellow-400 hover:text-[#001229] transition shadow-md" onclick="openTopupSheet()">ISI SALDO</button>
        ...
        <div id="topupBackdrop" class="fixed inset-0 bg-black/60 z-[120] hidden opacity-0 transition-opacity duration-300" onclick="closeTopupSheet()"></div>
        <div id="topupSheet" class="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-gray-50 dark:bg-[#001229] z-[130] rounded-t-[2rem] shadow-[0_-15px_40px_rgba(0,0,0,0.5)] transform translate-y-full transition-transform duration-300 pb-8 pt-2 border-t border-gray-200 dark:border-gray-800">
            ...
            <div class="px-6">
                <div class="flex justify-between items-center mb-5">
                    ...
                    <i class="fas fa-times text-gray-400 hover:text-red-500 cursor-pointer text-lg" onclick="closeTopupSheet()"></i>
                </div>
                
                <div class="flex items-center gap-3 mb-4">
                    <div class="relative flex-1">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-bold text-xs">Rp</span>
                        <input type="number" id="inputNominal" class="w-full bg-white dark:bg-[#0b1320] border border-gray-200 dark:border-[#0a2342] rounded-xl py-3 pl-9 pr-3 text-gray-800 dark:text-white font-bold text-sm focus:outline-none focus:border-[#002147] dark:focus:border-yellow-400 transition-colors shadow-sm" placeholder="Ketik nominal...">
                    </div>
                ...
                <div class="flex justify-between gap-2 mb-6">
                    <button onclick="setNominal(10000)" class="flex-1 bg-white dark:bg-[#0b1320] border border-gray-200 dark:border-gray-800 text-gray-800 dark:text-white font-extrabold py-2.5 rounded-xl hover:border-[#002147] dark:hover:border-yellow-400 transition-colors text-sm shadow-sm">10K</button>
                    <button onclick="setNominal(20000)" class="flex-1 bg-white dark:bg-[#0b1320] border border-gray-200 dark:border-gray-800 text-gray-800 dark:text-white font-extrabold py-2.5 rounded-xl hover:border-[#002147] dark:hover:border-yellow-400 transition-colors text-sm shadow-sm">20K</button>
                    <button onclick="setNominal(50000)" class="flex-1 bg-white dark:bg-[#0b1320] border border-gray-200 dark:border-gray-800 text-gray-800 dark:text-white font-extrabold py-2.5 rounded-xl hover:border-[#002147] dark:hover:border-yellow-400 transition-colors text-sm shadow-sm">50K</button>
                    <button onclick="setNominal(100000)" class="flex-1 bg-white dark:bg-[#0b1320] border border-gray-200 dark:border-gray-800 text-gray-800 dark:text-white font-extrabold py-2.5 rounded-xl hover:border-[#002147] dark:hover:border-yellow-400 transition-colors text-sm shadow-sm">100K</button>
                </div>

                <div class="flex flex-col gap-3">
                    <div id="method-wa" onclick="selectMethod('wa')" class="flex items-center justify-between bg-white dark:bg-[#001730] border border-gray-200 dark:border-[#0a2342] p-3 rounded-[1.2rem] cursor-pointer shadow-sm transition-all hover:border-[#002147] dark:hover:border-[#0a2342]">
                        ...
                        <div id="radio-wa" class="w-5 h-5 rounded-full border-2 border-gray-300 dark:border-gray-500 transition-colors bg-transparent mr-2 shrink-0"></div>
                    </div>
                    <div id="method-qris" onclick="selectMethod('qris')" class="flex items-center justify-between bg-white dark:bg-[#001730] border border-gray-200 dark:border-[#0a2342] p-3 rounded-[1.2rem] cursor-pointer shadow-sm transition-all hover:border-[#002147] dark:hover:border-[#0a2342]">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center p-2 border border-gray-200 dark:border-gray-800 shrink-0"><img src="https://upload.wikimedia.org/wikipedia/commons/a/a2/Logo_QRIS.svg" class="w-full object-contain"></div>
                            <span class="font-bold text-gray-800 dark:text-white text-[13px]">Top Up Otomatis QRIS</span>
                        </div>
                        <div id="radio-qris" class="w-5 h-5 rounded-full border-2 border-gray-300 dark:border-gray-500 transition-colors bg-transparent mr-2 shrink-0"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function selectMethod(method) {
            ...
            rWa.className = 'w-5 h-5 rounded-full border-2 border-gray-300 dark:border-gray-500 transition-colors bg-transparent mr-2 shrink-0';
            rQris.className = 'w-5 h-5 rounded-full border-2 border-gray-300 dark:border-gray-500 transition-colors bg-transparent mr-2 shrink-0';
            
            if(method === 'wa') {
                rWa.className = 'w-5 h-5 rounded-full border-[5px] border-[#002147] dark:border-yellow-400 bg-white dark:bg-[#0b1320] transition-colors mr-2 shrink-0';
                mWa.classList.add(isDark ? 'border-yellow-400' : 'border-[#002147]'); mWa.classList.remove('border-gray-200', 'dark:border-[#0a2342]');
                mQris.classList.remove(isDark ? 'border-yellow-400' : 'border-[#002147]'); mQris.classList.add('border-gray-200', 'dark:border-[#0a2342]');
            } else if(method === 'qris') {
                rQris.className = 'w-5 h-5 rounded-full border-[5px] border-[#002147] dark:border-yellow-400 bg-white dark:bg-[#0b1320] transition-colors mr-2 shrink-0';
                mQris.classList.add(isDark ? 'border-yellow-400' : 'border-[#002147]'); mQris.classList.remove('border-gray-200', 'dark:border-[#0a2342]');
                mWa.classList.remove(isDark ? 'border-yellow-400' : 'border-[#002147]'); mWa.classList.add('border-gray-200', 'dark:border-[#0a2342]');
            }
        }
...
# INFO & PROFIL DAN HALAMAN LAIN (KODE DIPERSINGKAT UNTUK HEMAT SCRIPT, FUNGSI TETAP)
...
<body class="bg-gray-50 dark:bg-[#0b1320] font-sans transition-colors duration-300">
    <div class="max-w-md mx-auto bg-gray-50 dark:bg-[#0b1320] min-h-screen relative pb-24 shadow-2xl overflow-x-hidden transition-colors">
        ...
        <div class="p-4" id="infoList"><div class="mt-20 flex flex-col items-center justify-center text-gray-400"><i class="fas fa-spinner fa-spin text-4xl mb-4"></i><p>Memuat informasi...</p></div></div>
        <div class="fixed bottom-0 w-full max-w-md bg-white dark:bg-[#001229] border-t border-gray-200 dark:border-gray-800 flex justify-around p-3 pb-4 shadow-[0_-10px_20px_-5px_rgba(0,0,0,0.1)] dark:shadow-[0_-10px_20px_-5px_rgba(0,0,0,0.5)] z-40 transition-colors">
...
<body class="bg-gray-50 dark:bg-[#0b1320] font-sans transition-colors duration-300">
    <div class="max-w-md mx-auto bg-gray-50 dark:bg-[#0b1320] min-h-screen relative pb-24 shadow-2xl overflow-x-hidden transition-colors">
        <div class="bg-white dark:bg-[#050b14] p-8 pb-10 flex flex-col items-center relative rounded-b-[2rem] shadow-sm dark:shadow-lg transition-colors">
            ...
            <div class="flex items-center gap-3"><h2 class="text-2xl font-bold tracking-wide text-gray-800 dark:text-gray-100" id="profileName">User Name</h2><i class="fas fa-pencil-alt text-gray-400 hover:text-[#002147] dark:hover:text-yellow-400 cursor-pointer transition text-lg" onclick="openEditModal()"></i></div>
        </div>
        <div class="mt-4 px-2">
