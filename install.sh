...
echo "=========================================================="
echo "    MENGINSTAL DIGITAL FIKY STORE - V47 (MENU GAME UI)    "
echo "=========================================================="
...
<body class="bg-gray-50 dark:bg-gray-900 font-sans transition-colors duration-300">
    ...
    <script>
        ...
        let alertCallback = null; function showAlert(title, msg, isSuccess, cb) { document.getElementById('alertTitle').innerText = title; document.getElementById('alertMessage').innerText = msg; document.getElementById('alertIcon').innerHTML = isSuccess ? '<i class="fas fa-check text-green-500"></i>' : '<i class="fas fa-tools text-yellow-500"></i>'; document.getElementById('customAlert').classList.remove('hidden'); alertCallback = cb; } function closeAlert() { document.getElementById('customAlert').classList.add('hidden'); if(alertCallback) alertCallback(); }
...
# HTML PROVIDER (NEW GAME GRID UI ADDED)
...
<body class="bg-gray-50 dark:bg-gray-900 font-sans transition-colors duration-300">
    <div class="max-w-md mx-auto bg-[#f4f6f9] dark:bg-gray-900 min-h-screen relative pb-8 shadow-2xl overflow-x-hidden">
        ...
        <div class="px-4 mt-6 mb-2">
            <p class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider ml-1" id="topLabel">Pilih Operator Tujuan</p>
        </div>

        <div class="mx-4" id="contentContainer">
            </div>
    ...
    <script>
        ...
        if (type === 'game') {
            document.getElementById('pageTitle').innerText = 'Top Up Game';
            topLabel.innerText = 'PILIH GAME FAVORITMU';
            
            contentContainer.innerHTML = `
            <div class="bg-white dark:bg-[#0f172a] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                <div class="bg-black text-white px-4 py-3 flex items-center gap-2">
                    <i class="fas fa-gamepad text-yellow-400"></i> <span class="font-bold text-[15px] tracking-wide">Game</span>
                </div>
                <div class="p-4 grid grid-cols-3 gap-3">
                    <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-3 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition" onclick="showAlert('Segera Hadir!', 'Menu nominal untuk Free Fire sedang tahap pengembangan.', false)">
                        <div class="w-14 h-14 rounded-full border-2 border-gray-300 dark:border-gray-600 flex items-center justify-center mb-2 text-[#001229] dark:text-yellow-400 font-black italic text-sm tracking-tighter">FF</div>
                        <span class="text-[10px] font-bold text-center text-[#001229] dark:text-gray-200">Free Fire</span>
                    </div>
                    <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-3 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition" onclick="showAlert('Segera Hadir!', 'Menu nominal untuk Mobile Legends sedang tahap pengembangan.', false)">
                        <div class="w-14 h-14 rounded-full border-2 border-gray-300 dark:border-gray-600 flex items-center justify-center mb-2 text-[#001229] dark:text-yellow-400 font-black italic text-[10px] text-center leading-tight tracking-tighter">ML<br>BB</div>
                        <span class="text-[10px] font-bold text-center text-[#001229] dark:text-gray-200 leading-tight mt-1">Mobile<br>Legends</span>
                    </div>
                    <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-3 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition" onclick="showAlert('Segera Hadir!', 'Menu nominal untuk PUBG Mobile sedang tahap pengembangan.', false)">
                        <div class="w-14 h-14 rounded-full border-2 border-gray-300 dark:border-gray-600 flex items-center justify-center mb-2 text-[#001229] dark:text-yellow-400 font-black italic text-xs tracking-tighter">PUBG</div>
                        <span class="text-[10px] font-bold text-center text-[#001229] dark:text-gray-200 leading-tight mt-1">PUBG<br>Mobile</span>
                    </div>
                    <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-3 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition" onclick="showAlert('Segera Hadir!', 'Menu nominal untuk Valorant sedang tahap pengembangan.', false)">
                        <div class="w-14 h-14 rounded-full border-2 border-gray-300 dark:border-gray-600 flex items-center justify-center mb-2 text-[#001229] dark:text-yellow-400 font-black italic text-[11px] tracking-tighter">VALO</div>
                        <span class="text-[10px] font-bold text-center text-[#001229] dark:text-gray-200 mt-1">Valorant</span>
                    </div>
                </div>
            </div>`;
        } else {
            document.getElementById('pageTitle').innerText = type === 'data' ? 'Paket Internet' : 'Isi Pulsa';
            topLabel.innerText = 'PILIH OPERATOR TUJUAN';
            ...
            let html = '<div class="bg-white dark:bg-[#0f172a] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">';
...
while true; do
    clear
    echo -e "${C}${B}╔═══════════════════════════════════════════════════╗${N}"
    echo -e "${C}${B}║${N} ${Y}⚡ DIGITAL FIKY STORE - VPS CONTROL PANEL (V47) ⚡${N} ${C}${B}║${N}"
    echo -e "${C}${B}╠═══════════════════════════════════════════════════╣${N}"
