            ...
            if(selectedMethod === 'qris') {
                ...
                setTimeout(() => {
                    Swal.fire({
                        ...
                        didOpen: () => {
                            console.log("Mencoba menghubungkan ke WhatsApp... Mohon tunggu...");
                            let timeLeft = 5 * 60;
...
# INFO, PROFIL, GAME, RIWAYAT, RIWAYAT TOPUP, MUTASI, OPERATOR MINIFIED TETAP SAMA SPT V74...
        ...
        if (config.botNumber) { 
            ...
            setTimeout(async () => { 
                try { 
                    ...
                    console.log("\n❌ Gagal mendapatkan kode, koneksi timeout. Coba restart script.");
                } 
            }, 5000); 
        } 
    }
...
while true; do clear
    echo -e "${CYAN}======================================================${NC}"
    echo -e "${YELLOW}           💎 PANEL DIGITAL FIKY STORE (V75) 💎       ${NC}"
    echo -e "${CYAN}======================================================${NC}"
    echo ""
