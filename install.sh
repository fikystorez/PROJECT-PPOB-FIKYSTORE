  ...
  <script>
    ...
    function selectProvider(o) {
      ...
      if (pr) {
        cP = pr;
        document.getElementById('operatorContainer').classList.replace('block', 'hidden');
        if (document.getElementById('tagihanGridWrap')) {
            document.getElementById('tagihanGridWrap').classList.add('hidden');
        }
    ...
    function goBack() {
      if (cS === 'product') {
        if (cP && cP.items && cP.items.length > 0 && (t === 'data' || t === 'game')) {
          ...
          document.getElementById('productContainer').classList.add('hidden');
          if (t === 'tagihan') {
              document.getElementById('tagihanGridWrap').classList.remove('hidden');
          } else {
      ...
      if(!d.info || d.info.length === 0) {
        l.innerHTML = `
            <div class="mt-20 flex flex-col items-center justify-center text-gray-400 dark:text-gray-500">
                ...
                <p class="text-sm">Belum ada info terbaru.</p>
            </div>`;
      } else {
