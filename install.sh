...
# INFO, PROFIL, MUTASI, OPERATOR, GAME MINIFIED TETAP SAMA SPT V50...
...
while true; do clear
    echo "==============================================="
    echo "      🤖 PANEL DIGITAL FIKY STORE (V59) 🤖     "
    echo "==============================================="
