#!/bin/bash
# ==========================================================
# DIGITAL FIKY STORE - V158 (THE PURE MAIZE - PART 1)
# ==========================================================
...
echo "=========================================================="
echo "    MENGINSTAL DIGITAL FIKY STORE V158 (PART 1)           "
echo "=========================================================="
...
<body class="bg-[#0b1320] font-sans transition-colors duration-300 text-white">
  <div class="max-w-md mx-auto bg-[#0b1320] min-h-screen relative pb-24 shadow-2xl overflow-x-hidden">
    ...
    <div class="flex justify-between items-center p-4 bg-[#0b1320] sticky z-40 top-0" id="headerMain">
      ...
      <div class="text-[10px] font-extrabold text-[#facc15] bg-[#1e293b] border border-[#facc15]/30 px-3 py-1.5 rounded-full shrink-0 shadow-sm" id="headTrx">
          0 Trx
      </div>
    </div>
    ...
    <div class="mx-4 mt-4 bg-[#162032] rounded-[1.2rem] p-4 text-white relative overflow-hidden shadow-lg border border-[#1e293b]">
      ...
      <div class="relative z-10 flex justify-between items-center">
        ...
        <div class="flex items-center gap-2">
          <button class="w-10 h-10 rounded-full bg-[#1e293b] flex items-center justify-center text-[#facc15] border border-[#334155] hover:bg-[#24344d] transition-colors z-10" onclick="bantuanAdmin()">
    ...
    <div class="mx-4 mt-8 mb-8">
      ...
      <div class="grid grid-cols-2 gap-3">
         <div class="bg-gradient-to-br from-[#162032] to-[#0b1320] border border-[#1e293b] rounded-2xl p-4 flex items-center cursor-pointer hover:shadow-md transition-shadow" onclick="bukaLinkKomunitas('tele')">
             <i class="fab fa-telegram text-4xl text-[#facc15] mr-3 drop-shadow-sm"></i>
             <div class="flex flex-col">
    ...
    <div id="topupSheet" class="fixed bottom-0 left-0 right-0 bg-[#050b14] z-[120] rounded-t-[2rem] transform translate-y-full transition-transform max-w-md mx-auto pb-safe">
      ...
      <div class="px-6 pb-6">
        ...
        <div class="relative w-full mb-4">
          ...
          <input type="number" id="inputNominal" class="w-full bg-[#0b1320] border border-gray-700 rounded-xl py-3 pl-10 pr-4 text-white font-bold focus:outline-none focus:border-[#facc15]" placeholder="Ketik nominal...">
        </div>

        <div class="flex justify-between gap-2 mb-6">
          <button onclick="document.getElementById('inputNominal').value=10000" class="flex-1 bg-[#0b1320] border border-gray-800 text-white font-extrabold py-2.5 rounded-xl hover:border-[#facc15]">10K</button>
          <button onclick="document.getElementById('inputNominal').value=20000" class="flex-1 bg-[#0b1320] border border-gray-800 text-white font-extrabold py-2.5 rounded-xl hover:border-[#facc15]">20K</button>
          <button onclick="document.getElementById('inputNominal').value=50000" class="flex-1 bg-[#0b1320] border border-gray-800 text-white font-extrabold py-2.5 rounded-xl hover:border-[#facc15]">50K</button>
          <button onclick="document.getElementById('inputNominal').value=100000" class="flex-1 bg-[#0b1320] border border-gray-800 text-white font-extrabold py-2.5 rounded-xl hover:border-[#facc15]">100K</button>
        </div>
...
<body class="bg-[#001229] font-sans transition-colors duration-300 text-white">
  ...
  <script>
    ...
    // POPUP DETAIL MEWAH OXFORD (PURE MAIZE)
...
echo "[5/7] Menulis logika Backend Node.js (SUPER UNCOMPRESSED - V158)..."
...
echo "[6/7] Memperbarui Panel Manajemen VPS (SUPER UNCOMPRESSED - THE PURE MAIZE)..."
...
while true; do 
    ...
    clear
    echo -e "${CYAN}======================================================${NC}"
    echo -e "${YELLOW}         💎 PANEL DIGITAL FIKY STORE (V158) 💎        ${NC}"
    echo -e "${CYAN}======================================================${NC}"
...
pm2 restart all > /dev/null 2>&1
echo "=========================================================="
echo "  SISTEM WEB V158 BERHASIL DIPERBARUI SECARA PENUH!       "
echo "  Ketik 'menu' di terminal untuk membuka panel manajemen  "
echo "=========================================================="

EOF
echo "[7/7] Menyelesaikan instalasi dan menyalakan Mesin Autopilot V158..."
...
echo -e "\033[1;33m       🚀 INSTALASI DIGITAL FIKY STORE V158 SELESAI! 🚀      \033[0m"
echo -e "\033[0;32m======================================================================\033[0m"
echo -e "\033[0;36mFITUR BARU DI V158 (THE PURE MAIZE & OXFORD EDITION):\033[0m"
echo -e "  ✅ \033[1;33mUI RIWAYAT 1000% CLONE FOTO\033[0m Background Oxford, Harga Kuning Maize"
echo -e "  ✅ \033[1;33mSISA BIRU MUDA DIMUSNAHKAN\033[0m Tab aktif, filter, spinner, nav bawah murni KUNING"
