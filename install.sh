...
# ==========================================
# FILE NODE.JS (API & MANAJEMEN LOKAL AUTO MARKUP)
# ==========================================
...
app.post('/api/products', async (req, res) => {
    ...
    // LOGIKA MARKUP BERTINGKAT (Berlaku untuk Digiflazz & Lokal)
    ...
    let combined = [
        ...
        ...myLocals.map(p => ({
            ...
            name: p.name,
            desc: p.desc,
            // PRODUK LOKAL SEKARANG JUGA KENA MARKUP OTOMATIS
            price: p.price + getMarkup(p.price), 
            isLocal: true
        }))
    ];
...
while true; do clear
    echo -e "${CYAN}======================================================${NC}"
    echo -e "${YELLOW}           💎 PANEL DIGITAL FIKY STORE (V89) 💎       ${NC}"
    echo -e "${CYAN}======================================================${NC}"
    echo ""
