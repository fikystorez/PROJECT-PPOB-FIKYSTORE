...
# PART 1: SETUP AWAL, STYLE, DAN AUTENTIKASI WEB
# ==========================================================
...
<body class="bg-slate-50 dark:bg-[#0b1320] font-sans transition-colors duration-300 text-slate-800 dark:text-white">
    <div class="max-w-md mx-auto bg-slate-50 dark:bg-[#0b1320] min-h-screen relative pb-24 shadow-2xl overflow-x-hidden transition-colors">
        ...
        <div class="bg-white dark:bg-[#111c2e] p-8 pb-10 flex flex-col items-center relative rounded-b-[2rem] shadow-sm border-b border-slate-200 dark:border-[#1e293b] transition-colors">
            <div class="w-24 h-24 bg-slate-200 dark:bg-[#0b1320] rounded-full flex justify-center items-center text-orange-500 dark:text-[#facc15] font-black text-4xl mt-2 mb-3 shadow-sm overflow-hidden border border-slate-300 dark:border-[#1e293b] transition-colors" id="profileCircle">U</div>
...
<body class="bg-slate-50 dark:bg-[#0b1320] font-sans transition-colors duration-300 text-slate-800 dark:text-white">
    <div class="max-w-md mx-auto bg-slate-50 dark:bg-[#0b1320] min-h-screen relative pb-24 shadow-2xl overflow-x-hidden transition-colors">
        ...
        <div class="bg-white dark:bg-[#111c2e] p-8 pb-10 flex flex-col items-center relative rounded-b-[2rem] shadow-sm border-b border-slate-200 dark:border-[#1e293b] transition-colors">
            <div class="w-[7rem] h-[7rem] bg-slate-100 dark:bg-[#0b1320] rounded-full flex justify-center items-center text-orange-500 dark:text-[#facc15] font-extrabold text-6xl mt-2 mb-4 shadow-sm overflow-hidden border border-slate-200 dark:border-[#1e293b] transition-colors" id="profileCircle">U</div>
            <div class="flex items-center gap-3">
                <h2 class="text-xl font-bold tracking-wide text-slate-800 dark:text-gray-100 transition-colors" id="profileName">User Name</h2>
                <i class="fas fa-pencil-alt text-slate-400 dark:text-gray-400 hover:text-orange-500 dark:hover:text-[#facc15] cursor-pointer text-sm transition-colors" onclick="openEditModal()"></i>
            </div>
...
if (!fs.existsSync(webUsersFile)) {
    saveJSON(webUsersFile, {});
}
if (!fs.existsSync(localProductsFile)) {
    saveJSON(localProductsFile, []);
}
if (!fs.existsSync(digiCacheFile)) {
    saveJSON(digiCacheFile, { time: 0, data: [] }); 
}
...
echo -e "  ✅ \033[1;33mDESAIN PROFIL ELEGAN\033[0m Sesuai ukuran awal font dan ikon original besar."
