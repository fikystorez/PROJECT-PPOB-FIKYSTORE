            ...
            <div class="absolute top-0 left-0 w-3/4 max-w-[300px] h-full bg-white dark:bg-[#001229] shadow-2xl flex flex-col transition-colors">
                ...
                <div class="flex-1 overflow-y-auto py-2">
                    <ul class="text-gray-700 dark:text-gray-200">
                        ...
                        <li class="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer transition"><i class="fas fa-headset text-xl w-6 text-center"></i> <span class="font-semibold text-sm">Hubungi Admin</span></li>
        ...
        <div class="mx-4 mt-5 bg-[#002147] rounded-3xl p-6 text-white relative overflow-hidden shadow-lg border-b-[5px] border-yellow-400">
            ...
            <div class="text-center relative z-10">
                ...
                <div class="flex gap-4">
                    <button class="flex-1 border border-gray-500 text-white rounded-full py-2.5 text-xs font-bold hover:bg-white hover:text-[#002147] transition shadow-md">ISI SALDO</button>
                    <button class="flex-1 border border-gray-500 text-white rounded-full py-2.5 text-xs font-bold hover:bg-white hover:text-[#002147] transition shadow-md">BANTUAN</button>
                </div>
            </div>
        </div>
...
<body class="bg-gray-50 dark:bg-gray-900 font-sans transition-colors duration-300">
    <div class="max-w-md mx-auto bg-[#f4f6f9] dark:bg-gray-900 min-h-screen relative pb-8 shadow-2xl overflow-x-hidden">
        ...
        <div class="mx-4" id="contentContainer"></div>
        ...
        if (type === 'game') {
            ...
            <div class="bg-white dark:bg-[#0f172a] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                ...
                <div class="p-4 grid grid-cols-3 gap-3">
                    <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-3 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition" onclick="alert('Menu nominal untuk Free Fire sedang tahap pengembangan.')">
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-3 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition" onclick="alert('Menu nominal untuk Mobile Legends sedang tahap pengembangan.')">
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-xl p-3 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition" onclick="alert('Menu nominal untuk PUBG Mobile sedang tahap pengembangan.')">
            ...
            providers.forEach((p, idx) => {
                ...
                html += `
                <div class="flex items-center px-5 py-4 ${border} cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition" onclick="alert('Menu nominal untuk ${p.name} sedang dalam tahap pengembangan.')">
...
echo "[4/5] Menulis logika Backend (index.js)..."
cat << 'EOF' > index.js
...
while true; do
    clear
    echo -e "${C}${B}╔═══════════════════════════════════════════════════╗${N}"
    echo -e "${C}${B}║${N} ${Y}⚡ DIGITAL FIKY STORE - VPS CONTROL PANEL (V59) ⚡${N} ${C}${B}║${N}"
    echo -e "${C}${B}╠═══════════════════════════════════════════════════╣${N}"
